      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            <Link
              to="/solutions"
              className="inline-flex items-center px-6 py-3 sm:px-8 sm:py-4 text-base sm:text-lg bg-primary text-white rounded-2xl hover:bg-secondary transition-all duration-300 transform hover:scale-105"
            >
              Explore Solutions
